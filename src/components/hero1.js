...
function MainSlider() {
  return (
    <div className="mx-auto max-w-[540px] sm:max-w-[768px] md:max-w-[992px] lg:max-w-[1200px] xl:max-w-[1410px] h-full border border-gray-200 rounded-lg shadow bg-gray-300 flex items-center justify-center overflow-hidden">
